  ...
  public void testCopyingModifierConfig() throws Exception {
    ...
    class ConfigurableComponent {
      ...
      ConfigurableComponent setA(int a) {
        return new ConfigurableComponent(config.apply(cfg -> cfg.a = a));
      }

      ConfigurableComponent setB(int b) {
        return new ConfigurableComponent(config.apply(cfg -> cfg.b = b));
      }

      ConfigurableComponent setC(int c) {
        return new ConfigurableComponent(config.apply(cfg -> cfg.c = c));
      }
    }
